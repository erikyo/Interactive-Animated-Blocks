...
class MyPointerSensor extends _dnd_kit_core__WEBPACK_IMPORTED_MODULE_9__.PointerSensor {}

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(MyPointerSensor, "activators", [{
  eventName: 'onPointerDown',
  handler: _ref => {
    let {
      nativeEvent: event
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__.addFilter)('blocks.registerBlockType', 'sscEditor/add-attributes', addAttributes);
const HandleIcon = wp.element.createElement('svg', {
  width: 20,
  height: 20,
  color: '#666'
...
function ActionRow(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    ref: setNodeRef,
    style: style
  }, attributes, listeners), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.Icon, {
    icon: HandleIcon,
    style: {
      height: 'auto',
      padding: '4px 0',
    ...
    className: 'col'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.SelectControl, {
    name: 'action',
    value: props.action,
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.TextControl, {
    name: 'value',
    value: props.value,
    id: props.id + '-value',
    onChange: e => props.handleChange(e, {
  ...
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.Button, {
    icon: 'remove',
...
function ActionList(props) {
  ...
  const sensors = (0,_dnd_kit_core__WEBPACK_IMPORTED_MODULE_9__.useSensors)((0,_dnd_kit_core__WEBPACK_IMPORTED_MODULE_9__.useSensor)(MyPointerSensor), (0,_dnd_kit_core__WEBPACK_IMPORTED_MODULE_9__.useSensor)(_dnd_kit_core__WEBPACK_IMPORTED_MODULE_9__.KeyboardSensor, {
  ...
  function handleDragEnd(event) {
    ...
    if (active.id !== over.id) {
      setAnimationProps(items => {
        ...
        return (0,_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_10__.arrayMove)(items, oldIndex, newIndex);
      });
    }
  }
  ...
  const addAction = () => {
    ...
    setAnimationProps([...animationProps.concat({
      id: newID,
      key: newID,
      action: _data__WEBPACK_IMPORTED_MODULE_7__.actionsTemplate[0].action,
      value: _data__WEBPACK_IMPORTED_MODULE_7__.actionsTemplate[0].valueDefault
    })]);
  ...
  function handleChange(ev, data) {
    ...
    if (data.changed === 'action') {
      ...
      newAnimationProps[selectedItem].value = _data__WEBPACK_IMPORTED_MODULE_7__.actionsTemplate.find(item => item.action === ev).valueDefault;
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("section", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("p", null, "Action Sequence"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_dnd_kit_core__WEBPACK_IMPORTED_MODULE_9__.DndContext, {
    sensors: sensors,
    collisionDetection: _dnd_kit_core__WEBPACK_IMPORTED_MODULE_9__.closestCenter,
    onDragEnd: handleDragEnd,
    style: wrapperStyle
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_10__.SortableContext, {
    items: animationProps,
    strategy: _dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_10__.verticalListSortingStrategy
    ...
    actionList: provideSelectOptions(_data__WEBPACK_IMPORTED_MODULE_7__.actionsTemplate, 'actionLabel', 'action'),
    style: {
      display: 'flex'
    },
...
const withAdvancedControls = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_5__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    ...
    } = props; // get default setting

    const getDefaults = opt => {
      const animationType = _data__WEBPACK_IMPORTED_MODULE_7__.animationTypes.filter(animation => {
    ...
    const pullData = function (data) {
      let type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'sscSequence';
      setOption(data, 'steps', type);
    }; // set the animation


    const updateAnimation = attr => {
      const animationOptions = sscAnimationOptions[attr] || {}; // get default options if the animation isn't initialized

      const defaults = getDefaults(attr);
      animationOptions[attr] = { ...defaults,
        ...animationOptions
      };
      setAttributes({
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(BlockEdit, props), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.PanelBody, {
      initialOpen: true,
      icon: "visibility",
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Screen Control')
    }, isSelected && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Animated'),
      checked: sscAnimated,
      onChange: () => setAttributes({
        sscAnimated: !sscAnimated
      }),
      help: !!sscAnimated ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Please choose an animation from the select input below.') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Not Animated.')
    }), sscAnimated && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.SelectControl, {
      label: 'Choose an animation type for ' + name,
      value: sscAnimationType,
      options: _data__WEBPACK_IMPORTED_MODULE_7__.animationTypes,
      onChange: e => updateAnimation(e)
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Reiterate'),
      checked: sscReiterate,
      onChange: () => setAttributes({
        sscReiterate: !sscReiterate
      }),
      help: !!sscReiterate ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Iterate the animation each time the object enters the screen') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("After the object has done it's job unmount it")
    }), ['sscSvgPath', 'sscSequence', 'sscVideoFocusPlay', 'sscScreenJacker', 'sscCounter', 'sscTextStagger'].includes(sscAnimationType) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.RangeControl, {
      label: 'Duration (ms)',
      ...
      label: 'Easing',
      value: sscAnimationOptions[sscAnimationType].easing,
      options: _data__WEBPACK_IMPORTED_MODULE_7__.animationEasings,
      onChange: e => setOption(e, 'easing', sscAnimationType)
    })), sscAnimationType === 'sscSequence' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(ActionList, {
      data: sscAnimationOptions[sscAnimationType].steps,
      type: sscAnimationType,
      func: pullData
    }), sscAnimationType === 'sscParallax' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.TextControl, {
    ...
    })), sscAnimationType === 'sscAnimation' && sscAnimationOptions[sscAnimationType] && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.SelectControl, {
      label: 'Entering animation name',
      options: _data__WEBPACK_IMPORTED_MODULE_7__.animationList,
    ...
    })), sscAnimationType === 'sscTextStagger' && sscAnimationOptions[sscAnimationType] && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.SelectControl, {
      label: 'preset',
      options: Object.keys(_data__WEBPACK_IMPORTED_MODULE_7__.textStaggerPresets),
      value: sscAnimationOptions[sscAnimationType].preset,
      onChange: e => setOption(e, 'preset', sscAnimationType)
    })), sscAnimationType === 'sscScreenJacker' && sscAnimationOptions[sscAnimationType] && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.TextControl, {
      label: 'Page Coverage (in %) needed before scroll-lock',
      type: 'number',
      value: sscAnimationOptions[sscAnimationType].intersection,
      onChange: e => setOption(e, 'intersection', sscAnimationType)
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("p", null, JSON.stringify(sscAnimationOptions)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Initial CSS'),
      value: initialCSS || '',
      className: 'ssc-codebox',
      onChange: attr => setAttributes({
        initialCSS: attr
      })
    }))));
  };
}, 'withAdvancedControls');
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__.addFilter)('editor.BlockEdit', 'sscEditor/with-advanced-controls', withAdvancedControls);
...
const addExtraProps = (extraProps, blockType, attributes) => {
  ...
  if (sscAnimated && sscAnimationType) {
    ...
    extraProps['data-ssc-reiterate'] = sscAnimated && sscReiterate ? 'true' : 'false';
    const options = sscAnimationOptions[sscAnimationType] || false;

    if (options && Object.keys(options).length) {
      extraProps['data-ssc-props'] = dataStringify(options, sscAnimationType);
    } // map the original array into a single key value object


    if (sscAnimationType === 'sscSequence') {
      const selected = sscAnimationOptions[sscAnimationType].steps || false;

      if (selected && Object.keys(sscAnimationOptions[sscAnimationType]).length) {
        extraProps['data-ssc-sequence'] = dataStringify(selected, 'sequence');
      }
    ...
    const hasTransition = sscAnimationOptions[sscAnimationType] && sscAnimationOptions[sscAnimationType].motion ? sscAnimationOptions[sscAnimationType].motion + 'ms' : false; // css style

    const CustomStyle = sscAnimated ? {
      transition: hasTransition || sscAnimated ? '350ms' : 0
    } : {};
    const initialStyle = initialCSS ? cssize(initialCSS) : []; // element classes

    const classes = sscAnimated ? 'ssc' : '';
    return Object.assign(extraProps, {
      className: classnames__WEBPACK_IMPORTED_MODULE_13___default()(extraProps.className, classes),
      style: { ...initialStyle,
        ...CustomStyle,
        ...extraProps.style
      }
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__.addFilter)('blocks.getSaveContent.extraProps', 'sscEditor/addExtraProps', addExtraProps);
})();
