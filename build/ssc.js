...
/* harmony import */ var _ssc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../ssc */ "./src/ssc.js");
...
/* harmony import */ var _modules_image360__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/image360 */ "./src/frontend/modules/image360.js");
/* harmony import */ var _modules_screenJumper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/screenJumper */ "./src/frontend/modules/screenJumper.js");
/* harmony import */ var _modules_imageScale__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/imageScale */ "./src/frontend/modules/imageScale.js");
/* harmony import */ var _modules_videoWheel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/videoWheel */ "./src/frontend/modules/videoWheel.js");
/* harmony import */ var _modules_videoFocus__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/videoFocus */ "./src/frontend/modules/videoFocus.js");
/* harmony import */ var _modules_scrollJacking__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/scrollJacking */ "./src/frontend/modules/scrollJacking.js");
/* harmony import */ var _modules_textStagger__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/textStagger */ "./src/frontend/modules/textStagger.js");
/* harmony import */ var _modules_textEffects__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/textEffects */ "./src/frontend/modules/textEffects.js");
/* harmony import */ var _modules_svgPath__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/svgPath */ "./src/frontend/modules/svgPath.js");
/* harmony import */ var _modules_itemAnimate__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/itemAnimate */ "./src/frontend/modules/itemAnimate.js");
...
class _ssc {
  ...
  constructor(options) {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "applyAnimateCssStylesheet", collected => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "addMetaToCollected", (el, index) => {
      ...
      el.sscItemOpts = el.dataset.sscProps ? (0,_utils_fn__WEBPACK_IMPORTED_MODULE_2__.getElelementData)(el.dataset.sscProps, 'data') : null;
      el.sscSequence = el.dataset && el.dataset.sscSequence ? (0,_utils_fn__WEBPACK_IMPORTED_MODULE_2__.getElelementData)(el.dataset.sscSequence, 'style') : null;
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "init", () => {
      if ('IntersectionObserver' in window) {
        ...
        this.observer = new window.IntersectionObserver(this.screenControl, {
          root: null,
          rootMargin: _ssc__WEBPACK_IMPORTED_MODULE_1__.sscOptions.rootMargin,
          threshold: _ssc__WEBPACK_IMPORTED_MODULE_1__.sscOptions.threshold
        });
        /**
        ...
        this.applyAnimateCssStylesheet(this.collected); // update the screen size if necessary
    ...
    this.scrollDirection = _utils_utils__WEBPACK_IMPORTED_MODULE_3__.scrollDirection.bind(this);
    ...
    this.page.ontouchstart = _utils_utils__WEBPACK_IMPORTED_MODULE_3__.touchstartEvent.bind(this);
    this.page.ontouchmove = _utils_utils__WEBPACK_IMPORTED_MODULE_3__.ontouchmoveEvent.bind(this); // the ssc enabled elements found in this page it's not an array but a nodelist (anyhow we can iterate with foreach so at the moment is fine)
    ...
    this.video360Controller = _modules_image360__WEBPACK_IMPORTED_MODULE_4__["default"];
    this.jumpToScreen = _modules_screenJumper__WEBPACK_IMPORTED_MODULE_5__["default"];
    this.imageScaleController = _modules_imageScale__WEBPACK_IMPORTED_MODULE_6__["default"];
    this.videoWheelController = _modules_videoWheel__WEBPACK_IMPORTED_MODULE_7__["default"];
    this.videoFocusPlay = _modules_videoFocus__WEBPACK_IMPORTED_MODULE_8__["default"];
    this.textStagger = _modules_textStagger__WEBPACK_IMPORTED_MODULE_10__["default"];
    this.textAnimated = _modules_textEffects__WEBPACK_IMPORTED_MODULE_11__["default"];
    this.animationSvgPath = _modules_svgPath__WEBPACK_IMPORTED_MODULE_12__["default"];
    this.animationSequence = _modules_itemCustomAnimation__WEBPACK_IMPORTED_MODULE_15__["default"];
    this.initTimeline = _modules_timeline__WEBPACK_IMPORTED_MODULE_17__.initTimeline; // The standard animation (animate.css)

    this.animations = [];
    this.handleAnimation = _modules_itemAnimate__WEBPACK_IMPORTED_MODULE_13__["default"].bind(this); // Screen jacking - evil as eval

    this.scrollJacking = _modules_scrollJacking__WEBPACK_IMPORTED_MODULE_9__["default"].bind(this); // Video playback controlled by scroll Y position
  ...
  updateScreenSize() {
    (async () => await (() => console.warn('Old Screensize', this.windowData)))().then(() => {
      return (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.delay)(250);
    }).then(() => {
...
const timelines = []; // TODO: enable only for admins
