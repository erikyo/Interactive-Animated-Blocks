...
/* harmony export */   "default": function() { return /* binding */ _ssc; },
/* harmony export */   "jumpToHash": function() { return /* binding */ jumpToHash; },
/* harmony export */   "windowData": function() { return /* binding */ windowData; }
/* harmony export */ });
/* harmony import */ var _ssc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ssc */ "./src/ssc.js");
...
/* harmony import */ var _modules_image360__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/image360 */ "./src/frontend/modules/image360.js");
/* harmony import */ var _modules_screenJumper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/screenJumper */ "./src/frontend/modules/screenJumper.js");
/* harmony import */ var _modules_imageScale__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/imageScale */ "./src/frontend/modules/imageScale.js");
/* harmony import */ var _modules_videoWheel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/videoWheel */ "./src/frontend/modules/videoWheel.js");
/* harmony import */ var _modules_videoFocus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/videoFocus */ "./src/frontend/modules/videoFocus.js");
/* harmony import */ var _modules_scrollJacking__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/scrollJacking */ "./src/frontend/modules/scrollJacking.js");
/* harmony import */ var _modules_textStagger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/textStagger */ "./src/frontend/modules/textStagger.js");
/* harmony import */ var _modules_textEffects__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/textEffects */ "./src/frontend/modules/textEffects.js");
/* harmony import */ var _modules_svgPath__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/svgPath */ "./src/frontend/modules/svgPath.js");
/* harmony import */ var _modules_itemAnimate__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/itemAnimate */ "./src/frontend/modules/itemAnimate.js");
/* harmony import */ var _modules_navigator__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/navigator */ "./src/frontend/modules/navigator.js");
/* harmony import */ var _modules_itemParallax__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/itemParallax */ "./src/frontend/modules/itemParallax.js");
/* harmony import */ var _modules_itemCustomAnimation__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/itemCustomAnimation */ "./src/frontend/modules/itemCustomAnimation.js");
/* harmony import */ var _modules_videoParallax__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/videoParallax */ "./src/frontend/modules/videoParallax.js");
/* harmony import */ var _modules_timeline__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/timeline */ "./src/frontend/modules/timeline.js");
/*!
 * SSC 0.0.1
...
class _ssc {
  constructor() {
    this.options = _ssc__WEBPACK_IMPORTED_MODULE_0__.options;
    /**
    ...
    this.observer = [];
    this.initMutationObserver = this.initMutationObserver.bind(this); // MODULES

    this.video360Controller = _modules_image360__WEBPACK_IMPORTED_MODULE_3__["default"];
    this.jumpToScreen = _modules_screenJumper__WEBPACK_IMPORTED_MODULE_4__["default"];
    this.imageScaleController = _modules_imageScale__WEBPACK_IMPORTED_MODULE_5__["default"];
    this.videoWheelController = _modules_videoWheel__WEBPACK_IMPORTED_MODULE_6__["default"];
    this.videoFocusPlay = _modules_videoFocus__WEBPACK_IMPORTED_MODULE_7__["default"];
    this.textStagger = _modules_textStagger__WEBPACK_IMPORTED_MODULE_9__["default"];
    this.textAnimated = _modules_textEffects__WEBPACK_IMPORTED_MODULE_10__["default"];
    this.animationSvgPath = _modules_svgPath__WEBPACK_IMPORTED_MODULE_11__["default"];
    this.initTimeline = _modules_timeline__WEBPACK_IMPORTED_MODULE_17__.initTimeline;
    this.navigator = _modules_navigator__WEBPACK_IMPORTED_MODULE_13__["default"]; // Screen jacking - evil as eval

    this.scrollJacking = _modules_scrollJacking__WEBPACK_IMPORTED_MODULE_8__["default"];
    this.sequenceAnimations = [];
    this.animationSequence = _modules_itemCustomAnimation__WEBPACK_IMPORTED_MODULE_15__["default"]; // The standard animation (animate.css)

    this.animations = [];
    this.handleAnimation = _modules_itemAnimate__WEBPACK_IMPORTED_MODULE_12__["default"].bind(this); // Video playback controlled by scroll Y position

    this.videoParallaxController = _modules_videoParallax__WEBPACK_IMPORTED_MODULE_16__["default"].bind(this); // Parallax Items

    this.itemParallaxed = _modules_itemParallax__WEBPACK_IMPORTED_MODULE_14__.itemParallaxed;
    this.parallax = _modules_itemParallax__WEBPACK_IMPORTED_MODULE_14__.parallax.bind(this);
    this.parallaxController = _modules_itemParallax__WEBPACK_IMPORTED_MODULE_14__.parallaxController.bind(this);
    this.init();
  }
  /**
  ...
  updateScreenSize() {
    let waitFor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 250;
    (async () => await (() => console.warn('Old Screensize', windowData)))().then(() => {
      return (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.delay)(waitFor);
    }).then(() => {
  ...
  applyAnimateCssStylesheet = collected => {
    const hasAnimate = Object.values(collected).filter(observed => observed.sscItemData.sscAnimation === 'sscAnimation');
  ...
  addMetaToCollected = (el, index) => {
    ...
    el.sscItemOpts = el.dataset.sscProps ? (0,_utils_fn__WEBPACK_IMPORTED_MODULE_1__.getElelementData)(el.dataset.sscProps, 'data') : null;
    el.sscSequence = el.dataset && el.dataset.sscSequence ? (0,_utils_fn__WEBPACK_IMPORTED_MODULE_1__.getElelementData)(el.dataset.sscSequence, 'style') : null;
    ...
    if (['sscVideoParallax', 'sscVideoScroll', 'sscVideoFocusPlay', 'ssc360'].includes(el.sscItemData.sscAnimation)) {
  ...
  init = () => {
    if ('IntersectionObserver' in window) {
      ...
      const page = _ssc__WEBPACK_IMPORTED_MODULE_0__.options.container || document.body;
      ...
      this.observer = new window.IntersectionObserver(this.screenControl, {
        root: null,
        rootMargin: _ssc__WEBPACK_IMPORTED_MODULE_0__.options.rootMargin,
        threshold: _ssc__WEBPACK_IMPORTED_MODULE_0__.options.threshold
      });
      /**
      ...
      this.collected.forEach(function (el, index) {
        ...
        if (el.sscItemData.sscAnimation === 'sscScrollTimeline') {
          // init ScrollMagic
          (0,_modules_timeline__WEBPACK_IMPORTED_MODULE_17__.addToTimeline)(el);
        } else {
          // watch the elements to detect the screen margins intersection
          this.observer.observe(el);
        }
      }, this); // injects animate.css stylesheet

      this.applyAnimateCssStylesheet(this.collected);
      const isAdmin = document.body.classList.contains('logged-in');

      if (isAdmin) {
        (0,_modules_timeline__WEBPACK_IMPORTED_MODULE_17__.enableScrollMagicIndicators)();
      }

      this.initTimeline(); // start parallax

      this.parallax();
      this.jumpToScreen(document.querySelectorAll('.ssc-screen-jumper')); // watch for new objects added to the DOM

      this.interceptor(_ssc__WEBPACK_IMPORTED_MODULE_0__.options.container);
      this.updateScreenSize(); // update the screen size if necessary

      window.addEventListener('resize', _utils_utils__WEBPACK_IMPORTED_MODULE_2__.screenBodyClass);
      window.addEventListener('scroll', _utils_utils__WEBPACK_IMPORTED_MODULE_2__.screenBodyClass);
    } else {
  ...
  updateItemData = entry => {
    const elCenter = (entry.boundingClientRect.top + entry.boundingClientRect.bottom) / 2; // stores the direction from which the element appeared

    entry.target.dataset.intersection = windowData.viewHeight / 2 > elCenter ? 'up' : 'down';
    /**
  ...
  screenControl = entries => {
    ...
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.scrollDirection)(true);
    ...
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.screenBodyClass)();
  };
...
const video360Controller = entry => {
  ...
  videoEl.handle360byTouch = e => {
    const video = e.target; // store the event initial position
...
/* harmony default export */ __webpack_exports__["default"] = (video360Controller);
...
/* harmony default export */ __webpack_exports__["default"] = (imageScaleController);
  ...
  if (!this.animations[entry.target.sscItemData.sscItem]) {
    if (!entry.target.isChildren) {
      ...
      this.animations[entry.target.sscItemData.sscItem] = {
        ...
        locked: false,
        intersection: parseInt(entry.target.sscItemOpts.intersection, 10) || 80,
        lastAction: false,
        ...
        animateItem(action) {
          ...
          Object.values(this.animatedElements).forEach((child, index) => {
            ...
            child.locked = true;
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.delay)(animationDelay).then(() => {
              ...
              new Promise(resolve => {
                setTimeout(() => {
                  child.locked = false;
                  child.lastAction = child.lastAction === 'enter' ? 'leave' : 'enter';
                  resolve();
                }, child.duration);
              });
            });
        ...
        initElement() {
          ...
          this.updatePosition(); // we need to set the opposite of the next action
          ...
          if (this.duration) {
            entry.target.style.setProperty('--animate-duration', this.duration + 'ms');
          }

          if (this.easing) {
            entry.target.style.setProperty('transition-timing-function', this.easing);
          } // check if the item is a single animation


          if (this.stagger !== 'none') {
            // collect item childs
            this.animatedElements = entry.target.querySelectorAll('.ssc-animated'); // if scc animated items aren't found use item childs
      ...
      this.animations[entry.target.sscItemData.sscItem].initElement(); // this.animations[ entry.target.sscItemData.sscItem ].animateItem( this.lastAction );
    } else {
      ...
      if (entry.target.sscItemOpts && entry.target.sscItemOpts.duration) {
        entry.target.style.setProperty('--animate-duration', (parseInt(entry.target.sscItemOpts.duration, 10) || 5000) + 'ms');
      }
    }
...
/* harmony default export */ __webpack_exports__["default"] = (handleAnimation);
...
/* harmony default export */ __webpack_exports__["default"] = (animationSequence);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "itemParallaxed": function() { return /* binding */ itemParallaxed; },
...
/***/ "./src/frontend/modules/navigator.js":
/*!*******************************************!*\
  !*** ./src/frontend/modules/navigator.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/utils */ "./src/utils/utils.js");
/* harmony import */ var _ssc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_ssc */ "./src/frontend/_ssc.js");
/**
...
function navigator(entry) {
  ...
  function createNavigation(childrens) {
    ...
    if (childrens) {
      ...
      headerLabels.id = 'navigator-labels'; // append the steps list to the header

      header.append(headerLabels); // the progress bar wrapper

      const progressBarContainer = document.createElement('div');
      progressBarContainer.id = 'navigator-progress-container'; // contains the dots
      ...
      Object.values(childrens).forEach((child, key) => {
        ...
        c.slug = 'step-' + c.id;
        c.title = 'step-' + key;
        c.scrollY = lastScrollPosition + child.getBoundingClientRect().top; // store the step Y position

        navigationSteps[c.id] = c.scrollY; // store the navigation data (id, title)
      ...
      progressBarContainer.append(headerDotWrapper); // the progress bar

      const progressBar = document.createElement('progress');
      progressBar.id = 'navigator-progress-bar';
      progressBar.value = 0;
      progressBar.max = 100;
      progressBar.style = 'width: 100%; transition:100ms'; // ally
      ...
      progressBarLabel.textContent = 'navigations step progress'; // append the progress bar
  ...
  function observeNavigation() {
    ...
    if ((0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.isPartiallyVisible)(wrapper)) {
      if (lastY === _ssc__WEBPACK_IMPORTED_MODULE_1__.windowData.lastScrollPosition) {
        return window.requestAnimationFrame(observeNavigation);
      }

      lastY = _ssc__WEBPACK_IMPORTED_MODULE_1__.windowData.lastScrollPosition;
...
/* harmony default export */ __webpack_exports__["default"] = (jumpToScreen);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "hasScrolling": function() { return /* binding */ hasScrolling; },
/* harmony export */   "screenJackTo": function() { return /* binding */ screenJackTo; },
/* harmony export */   "scrollJacking": function() { return /* binding */ scrollJacking; }
/* harmony export */ });
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/utils */ "./src/utils/utils.js");
...
/* harmony import */ var _utils_compat__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/compat */ "./src/utils/compat.js");
// ScrollTo
...
function screenJackTo(el) {
  ...
  window.addEventListener(_utils_compat__WEBPACK_IMPORTED_MODULE_2__.mouseWheel, _utils_utils__WEBPACK_IMPORTED_MODULE_0__.disableWheel, {
    passive: false
  });
  window.addEventListener('touchmove', _utils_utils__WEBPACK_IMPORTED_MODULE_0__.disableWheel, false);
  const easing = el.sscItemOpts.easing.replace('easeI', 'i').replace('easeO', 'o');
  scroll_to_element__WEBPACK_IMPORTED_MODULE_1___default()(el, {
    offset: 0,
    ease: easing || 'inQuad',
    // https://github.com/component/ease
    duration: duration || 1000
  }).on('end', () => {
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.delay)(scrollDelay).then(() => {
      hasScrolling = false;
      window.removeEventListener(_utils_compat__WEBPACK_IMPORTED_MODULE_2__.mouseWheel, _utils_utils__WEBPACK_IMPORTED_MODULE_0__.disableWheel);
      window.removeEventListener('touchmove', _utils_utils__WEBPACK_IMPORTED_MODULE_0__.disableWheel);
    });
  });
}
/**
...
function scrollJacking(entry) {
  ...
  if (!hasScrolling && (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.isInside)(entry.target, intersection)) {
    return screenJackTo(entry.target);
  }

  if ((0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.isPartiallyVisible)(entry.target)) {
    return (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.delay)(200).then(() => scrollJacking(entry));
  }
}
/* harmony default export */ __webpack_exports__["default"] = (scrollJacking);
...
/* harmony default export */ __webpack_exports__["default"] = (animationSvgPath);
...
function textAnimated(el) {
  ...
  if (el.target.sscItemOpts.target === 'number') {
    ...
    if (!el.target.dataset.init) {
      const replaced = (0,_utils_fn__WEBPACK_IMPORTED_MODULE_2__.splitSentence)(el.target.textContent, 'letters');
...
function textStagger(entry) {
  ...
  if (item.action === 'enter' && (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.isActiveArea)(entry.target, intersectionArea)) {
...
/* harmony default export */ __webpack_exports__["default"] = (textStagger);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addToTimeline": function() { return /* binding */ addToTimeline; },
/* harmony export */   "enableScrollMagicIndicators": function() { return /* binding */ enableScrollMagicIndicators; },
/* harmony export */   "initTimeline": function() { return /* binding */ initTimeline; },
/* harmony export */   "timelines": function() { return /* binding */ timelines; }
/* harmony export */ });
/* harmony import */ var animejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! animejs */ "./node_modules/animejs/lib/anime.es.js");
...
function enableScrollMagicIndicators() {
  console.log('scrollMagic ScrollMagicPluginIndicator enabled');
  (0,scrollmagic_plugins__WEBPACK_IMPORTED_MODULE_2__.ScrollMagicPluginIndicator)((scrollmagic__WEBPACK_IMPORTED_MODULE_1___default()));
}
/**
...
/* harmony default export */ __webpack_exports__["default"] = (videoFocusPlay);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "parallaxVideos": function() { return /* binding */ parallaxVideos; }
/* harmony export */ });
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/utils */ "./src/utils/utils.js");
...
function videoParallaxCallback(video) {
  ...
  if (video.item.readyState > 1) {
    if (video.hasExtraTimeline) {
      ...
      video.item.currentTime = ((window.scrollY - rect.top - video.distanceTop + rect.height) / video.timelineLength * video.videoDuration * video.playbackRatio).toFixed(5);
    } else {
...
function parallaxVideos() {
  ...
  videoParallaxed.forEach(video => videoParallaxCallback(video)); // Store the last position
...
function videoParallaxController(entry) {
  ...
  if (videoEl && !videoParallaxed[entry.target.sscItemData.sscItem]) {
    if ((0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.isPartiallyVisible)(videoEl)) {
      ...
      const timelineDuration = parseInt(entry.target.sscItemData.timelineDuration, 10) || 0;
      ...
      videoParallaxed[entry.target.sscItemData.sscItem] = {
        ...
        // works 99% of the time but needs to be fixed in case of timeline-child (in this case we need to get the parent container Y)
        playbackRatio: parseFloat(entry.target.sscItemOpts.playbackRatio).toFixed(5)
      };
    }
...
/* harmony default export */ __webpack_exports__["default"] = (videoParallaxController);
...
/* harmony default export */ __webpack_exports__["default"] = (videoWheelController);
...
const options = { ...sscOptionsDefault
};
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "actionsTemplate": function() { return /* binding */ actionsTemplate; },
/* harmony export */   "animationEasings": function() { return /* binding */ animationEasings; },
/* harmony export */   "animationList": function() { return /* binding */ animationList; },
/* harmony export */   "animationTypes": function() { return /* binding */ animationTypes; },
/* harmony export */   "cssAnimationsEasings": function() { return /* binding */ cssAnimationsEasings; },
/* harmony export */   "textStaggerPresets": function() { return /* binding */ textStaggerPresets; },
/* harmony export */   "textStaggerPresetsNames": function() { return /* binding */ textStaggerPresetsNames; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "autoLintCode": function() { return /* binding */ autoLintCode; },
/* harmony export */   "capitalToloDash": function() { return /* binding */ capitalToloDash; },
/* harmony export */   "css2obj": function() { return /* binding */ css2obj; },
/* harmony export */   "dataStringify": function() { return /* binding */ dataStringify; },
/* harmony export */   "getDefaults": function() { return /* binding */ getDefaults; },
/* harmony export */   "getElelementData": function() { return /* binding */ getElelementData; },
/* harmony export */   "lintCSS": function() { return /* binding */ lintCSS; },
/* harmony export */   "loDashToCapital": function() { return /* binding */ loDashToCapital; },
/* harmony export */   "parseCSS": function() { return /* binding */ parseCSS; },
/* harmony export */   "splitSentence": function() { return /* binding */ splitSentence; },
/* harmony export */   "styleObj2String": function() { return /* binding */ styleObj2String; }
/* harmony export */ });
...
const parseCSS = style => {
  ...
  result = result.match('this {(.*?)}')[1]; // convert jss to css
...
function splitSentence(sentence) {
  ...
  const result = words.map(word => {
    ...
    return '<span class="word">' + word.replace(/([^\x00-\x80]|\w)/g, `<span class="letter">$&</span>`) + '</span>';
  });
  return result.join(' ');
}
/**
...
/* harmony export */   "disableWheel": function() { return /* binding */ disableWheel; },
/* harmony export */   "hasMouseOver": function() { return /* binding */ hasMouseOver; },
/* harmony export */   "isActiveArea": function() { return /* binding */ isActiveArea; },
/* harmony export */   "isFullyVisible": function() { return /* binding */ isFullyVisible; },
/* harmony export */   "isInView": function() { return /* binding */ isInView; },
...
/* harmony export */   "ontouchmoveEvent": function() { return /* binding */ ontouchmoveEvent; },
/* harmony export */   "screenBodyClass": function() { return /* binding */ screenBodyClass; },
...
/* harmony export */ });
/* harmony import */ var _frontend_ssc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../frontend/_ssc */ "./src/frontend/_ssc.js");
...
const isPartiallyVisible = el => {
  ...
  const innerHeight = _frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.viewHeight;

  if (rect.height <= innerHeight) {
    return rect.bottom >= 0 || rect.top <= innerHeight;
  }

  return rect.top >= 0 && rect.top <= innerHeight || rect.bottom >= 0 && rect.bottom <= innerHeight || rect.top < 0 && rect.bottom > innerHeight;
};
/**
...
const isFullyVisible = el => {
  const rect = el.getBoundingClientRect();
  return rect.top >= 0 && rect.bottom <= _frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.viewHeight;
};
/**
...
const isInside = (el, rangePosition) => {
  const rect = el.getBoundingClientRect();
  const innerHeight = window.innerHeight; // eg. 20 (%) of 1000 (px) are the slice inside 100px from top and 100px from bottom

  const limit = innerHeight * 0.005 * rangePosition; // if the element top side is inside the view

  if (_frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.direction === 'down') {
    return limit < rect.top && rect.top < innerHeight - limit;
  } else if (_frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.direction === 'up') {
...
function scrollDirection() {
  ...
  if (_frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.lastScrollPosition < scrollY) {
    _frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.direction = 'down';
  } else if (_frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.lastScrollPosition > scrollY) {
    _frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.direction = 'up';
  }

  if (update) _frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.lastScrollPosition = scrollY;
}
/**
...
const screenBodyClass = () => {
  ...
  if (_frontend_ssc__WEBPACK_IMPORTED_MODULE_0__.windowData.lastScrollPosition < 5) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ScrollMagicPluginGsap": function() { return /* binding */ ScrollMagicPluginGsap; },
/* harmony export */   "ScrollMagicPluginIndicator": function() { return /* binding */ ScrollMagicPluginIndicator; },
/* harmony export */   "ScrollMagicPluginJQuery": function() { return /* binding */ ScrollMagicPluginJQuery; },
/* harmony export */   "ScrollMagicPluginVelocity": function() { return /* binding */ ScrollMagicPluginVelocity; }
/* harmony export */ });
